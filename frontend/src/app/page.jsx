  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "5px 5px 16px rgba(0,0,0,0.28), -2px -2px 8px rgba(255,255,255,0.18), inset 0 1px 0 rgba(255,255,255,0.22)",
        }}
      >
      ...
      <div className="flex-1">
        <h3
          className={`font-bold text-base mb-1.5 ${isDark ? "text-white" : "text-slate-800 dark:text-slate-100"}`}
        >
          {f.label}
        </h3>
        <p
          className={`text-sm leading-relaxed ${isDark ? "text-slate-500" : "text-slate-600 dark:text-slate-400"}`}
        >
          {f.desc}
        </p>
      </div>
      ...
      {f.stats && (
        <div className="flex gap-2 mt-auto">
          {f.stats.map((s) => (
            ...
            >
              <div
                className={`text-sm font-extrabold font-display ${isDark ? "text-violet-400" : "text-violet-600 dark:text-violet-400"}`}
              >
                {s.v}
              </div>
              <div className="text-[9px] font-semibold mt-0.5 text-slate-500 dark:text-slate-400">
                {s.l}
              </div>
            </div>
          ))}
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 pt-10 pb-24 space-y-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          ...
          <div
            ...
            style={{
              boxShadow:
                "8px 8px 32px rgba(91,82,255,0.40), -4px -4px 16px rgba(255,255,255,0.12), inset 0 1px 0 rgba(255,255,255,0.22)",
            }}
          >
            <div
            ...
            <div className="relative z-10">
              ...
              >
                Your Developer
                <br />
                Career, <span className="text-white/65">Accelerated.</span>
              </h1>
              <p className="text-white/65 text-sm md:text-base leading-relaxed max-w-sm">
                From practice to placement — master the full stack with AI tools
                and curated interview prep. Free forever.
              </p>
            </div>
            ...
            <div className={`${CARD} p-7 flex flex-col justify-between`}>
              ...
              <div>
                ...
                <p className="text-xs mt-2 flex items-center gap-1 text-slate-500 dark:text-slate-400">
                  <TrendingUp size={11} className="text-emerald-500" /> Across 6
                  domains
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div
            className={`${CARD} sm:col-span-2 p-8 md:p-10 flex flex-col justify-between`}
          >
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400 max-w-sm">
                AI resume optimizer, curated interview prep, and 150+ practice
                topics — all in one free platform.
              </p>
            </div>
          </div>
        ...
        <section aria-labelledby="features-heading">
          <div className="text-center mb-7 pt-2">
            ...
            <p className="max-w-md mx-auto text-sm text-slate-500 dark:text-slate-400">
              One platform. Zero fluff. Built for developers who take their
              career seriously.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={q} className={`${CARD} px-6 py-5`}>
                <h3 className="font-bold text-sm mb-2 text-slate-800 dark:text-slate-100">
                  {q}
                </h3>
        ...
        <section
          ...
          style={{
            boxShadow:
              "10px 10px 36px rgba(91,82,255,0.45), -5px -5px 18px rgba(255,255,255,0.14), inset 0 1px 0 rgba(255,255,255,0.20)",
          }}
        >
          <div
