  ...
  "@graph": [
    {
      ...
      name: "ProDev",
      description:
        "Developer Career Platform — Coding Practice, Interview Prep & AI Resume Optimizer",
      potentialAction: {
        "@type": "SearchAction",
        target: {
          "@type": "EntryPoint",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes, ProDev is completely free. No credit card required.",
          },
        },
        {
          "@type": "Question",
