...
import {
  Briefcase, Mail, Lock, User, Eye, EyeOff, AlertCircle,
} from "lucide-react";
import { NeuCard, NeuButton } from "../components/ui";
import { useAuth } from "../context/AuthContext";

function Field({ label, type, value, onChange, placeholder, icon: Icon, rightSlot }) {
  return (
    <div>
      ...
      >
        ...
        <NeuCard>
          ...
          <form onSubmit={submit} className="space-y-4">
              ...
              {mode === "register" && (
                ...
                >
                  <Field
                    ...
                    placeholder="Jane Developer" icon={User}
                  />
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <NeuButton variant="primary" className="w-full py-3!" disabled={loading}>
              {loading ? (
